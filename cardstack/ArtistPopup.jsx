		...
		xhr.onreadystatechange=function() {
          ...
          if(messageObject.error){
            ...
            if(messageObject.error.hasOwnProperty("message")) {
              parent.setState({ errorMessage: "Add database failure for " + id + ".  Error: " + messageObject.error.message });
            }
            else if(messageObject.error.hasOwnProperty("errmsg")) {
              parent.setState({ errorMessage: "Add database failure for " + id + ".  Error: " + messageObject.error.errmsg });
            }
          }
          else {
            parent.add(
